...
struct AIAccountModelFormView: View {
    ...
    var body: some View {
        Form {
            Section {
                OutlinedTextField(label: L10n.t("模型 ID"), prompt: L10n.t("如 deepseek-v4-flash"), text: $modelId)
                    .textInputAutocapitalization(.never)
                    .autocorrectionDisabled()
                    .font(.dataMonospacedBody)
                    .disabled(editing != nil)
                OutlinedTextField(label: L10n.t("名称"), prompt: L10n.t("显示名称，可与模型 ID 不同"), text: $modelName)
                    .textInputAutocapitalization(.never)
                    .autocorrectionDisabled()
            } header: {
